...
public class PagingListView extends ListView {
    ...
    public void scrollNextPage(){
        ...
        //smoothScrollBy(this.getHeight()-SizeUtil.getStatusBarHeight(context)-Math.abs(firstVisibleView.getTop())-1, 400);
        this.smoothScrollToPosition(nowPage);
        this.refreshDrawableState();
        //nowPage = getFirstVisiblePosition();
    }
    ...
    public void scrollLastPage(){
        nowPage = totalPage-2;
        //smoothScrollBy(firstVisibleView.getTop(), 400); // Stops the listview from overshooting.
        this.smoothScrollToPosition(totalPage-2);
        this.refreshDrawableState();
    }
